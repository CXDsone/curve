...
QT_MOC_LITERAL(3, 21, 16), // "on_PB_ok_clicked"
QT_MOC_LITERAL(4, 38, 20) // "on_PB_cancel_clicked"

    },
    "DialogSetup\0setData\0\0on_PB_ok_clicked\0"
...
void DialogSetup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DialogSetup::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DialogSetup::setData)) {
                *result = 0;
                return;
            }
        }
